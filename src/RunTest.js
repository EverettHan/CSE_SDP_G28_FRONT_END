      ...
      <div className="mg20">
        <Typography paragraph>
          <h2>
            ...
            <h4>Our test uses a machine learning model to give a Covid-19 diagnosis. Select any image file to receive a result.</h4>
        </Typography>
        <div>
        ...
        <div>
          ...
          {!bHasTestResult ? null : (
            <div>
              { !bTestPositive && (
                <Typography variant="h6" className="list-header">
                  Test Result:  Congratuations, the test result is negative. The prediction number is {testPred}
                </Typography>
              )
              }
              { bTestPositive && (
